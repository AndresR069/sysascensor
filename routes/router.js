...
router.get("/adminuser", (req, res) => { //Plantilla adminser -->tecnicos de usuario
  conexion.query('SELECT * FROM tecnico_encargado',(error, result)=>{
    if(error){
        throw error;
    } else {                       
...
router.post('/guardar_tecnico', crud.editar_tecnico);
router.post('/editar_tecnico',crud.editar_tecnico)
